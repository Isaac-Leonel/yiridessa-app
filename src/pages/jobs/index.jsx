...
const jobs = [
    ...
    },
    {
        jobName: 'Domador',
        url: 'mestre_prf.jpg',
        text: `O Mestre de Bestas, também conhecido como Escravista, desempenha um papel abrangente na manipulação e subjugação de criaturas. Ele é responsável pela captura e treinamento de lacaios, empregando uma variedade de métodos, desde o ensino e cuidado carinhoso até práticas cruéis, como a tortura, para subjugar os lacaios de maneira agressiva e sanguinária.
            <br>
            Os Mestres de Bestas, além de lidar com a criação e treinamento de lacaios, são os principais comerciantes de escravos no reino.  Além disso, os Mestres de Bestas, como especialistas no reino animal, são hábeis na criação e comércio de cavalos, seguidores ferozes e selas para animais.`
    },
    {
        jobName: 'Taverneiro',
        url: 'taverneiro_prf.jpg',
        text: `Encarregados de proporcionar a alimentação e entretenimento na taverna, os taverneiros destacam-se pela habilidade em preparar as melhores receitas. Seja revitalizando seus aliados com saborosas sopas e carnes, aquecendo com bebidas vigorosas ou refrescando com sucos requintados, esses profissionais executam suas tarefas com maestria. Além disso, têm a capacidade de atrair os mais talentosos artistas para animar a taverna e asseguram que nenhum espírito negativo ou impuro encontre morada em seus recintos.
            <br>
            Como únicos responsáveis pela coleta e comercialização de ícor e óleo, os taverneiros também detêm o monopólio das caixas de preservação, essenciais para conservar alimentos em estoque, sendo violação gravíssima o repasse dessas caixas para outro jogador. Para além das atividades gastronômicas, os taverneiros frequentemente recebem chamados para liderar expedições, reunindo os mais habilidosos heróis e líderes natos caçadores para tal empreitada. Adicionalmente, são encarregados de divulgar eventos e novidades pelo continente.
            <br>
            É imperativo salientar que os taverneiros não têm permissão para integrar qualquer clã, mantendo, assim, sua independência e imparcialidade no cenário de qualquer reino.`
    },
    {
        jobName: 'Caçador',
        url: 'cacador_prf.jpg',
        text: `O espírito da caçada flui nas veias do verdadeiro caçador, cuja emoção é expressa nitidamente em seus olhos. Ao lidar com criaturas indomáveis, os caçadores se destacam como verdadeiros aniquiladores destas. Quando a ordem dos caçadores é proclamada, é garantido que nenhuma criatura listada permanecerá para contar sua história.
            <br>
            Os caçadores são figuras incontornáveis quando se trata de aventuras, sendo os responsáveis pelas expedições e condução dos exilados a locais perigosos, cavernas e equipes destinadas a enfrentar os monstros mais formidáveis. Detêm a exclusividade na produção de equipamentos lendários únicos, sendo peças fundamentais para as expedições das tavernas.
            <br>
